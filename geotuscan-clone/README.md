...
- 요약 줄: 거래건수 / 중위 매매가 / 중위 전용평수 / 중위 건축년도 + 연도별 건수
- 거래 목록 표: 계약일 · 동 · 건물명 · 전용평수 · 층수 · 건축년도 · 매매금액
- 탭 4종(층수·건축년도·전용평수·매매금액)은 **정렬 기준**이다. 같은 탭을 다시
  누르면 오름/내림이 뒤집힌다. 표 머리글을 눌러도 같다. 기본은 매매금액 내림차순.
- 50건씩 끊어 보여주고 "더 보기"로 이어 붙인다 (한 지역에 수천 건이 나올 수 있다)
